...
export default function ProductCard({ handleDetail }) {
    const productsArr = [
        {
            title: 'Colors',
            price: 100,
                ...
                <div className="container">
                    <div className="row">
                        {productsArr.map((product, index) => (
                            <div key={index} className="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                <div className="productCard">
                                    <div className="productCardImg" style={{ backgroundImage: `url(${product.imageUrl})` }}></div>
                                    <div className={`${"productCardImg"} ${"productCardHoverImg"}`} style={{ backgroundImage: `url(${product.imageUrl})` }}></div>
                                    <div className="productCardWishlist">
                                    ...
                                    <div className="productCardContent">
                                        <h4>{product.title}<Button>Add to cart</Button></h4>
